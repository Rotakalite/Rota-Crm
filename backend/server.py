...
class SupplierEvaluationInput(BaseModel):
    supplier_id: str
    environmental_performance: int = Field(ge=0, le=100)
    social_responsibility: int = Field(ge=0, le=100)
    quality_score: int = Field(ge=0, le=100)
    cost_effectiveness: int = Field(ge=0, le=100)
...
class SupplierEvaluation(BaseModel):
    ...
    supplier_id: str
    client_id: str
    environmental_performance: int
    social_responsibility: int
    quality_score: int
    cost_effectiveness: int
    delivery_reliability: int
    communication: int
    overall_score: float  # Calculated average
    notes: Optional[str] = None
