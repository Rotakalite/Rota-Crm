...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://49bb8af5-7a60-4e2b-86e9-bfb706f9a616.preview.emergentagent.com",  # Current reported URL
        "https://49bb8af5-7a60-4e2b-86e9-bfb706f9a616.preview.emergentagent.com",  # Current env URL
    ...
    try:
        ...
        try:
            await email_service.send_email(
                to_email=user_email,
                subject="Rota CRM - Güvenlik Kodu",
                html_content=f"""
                <h2>Güvenlik Kodunuz</h2>
                <p>Rota CRM giriş için güvenlik kodunuz: <strong>{verification_code}</strong></p>
