    ...
    def test_02_belge_list(self):
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                logger.warning("⚠️ GET /api/belge/list with invalid auth returns 200 - authentication may not be enforced")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 403:
                ...
                logger.warning("⚠️ GET /api/belge/list with no auth returns 200 - authentication may not be enforced")
        except Exception as e:
    ...
    def test_03_belge_upload(self):
        ...
        try:
            ...
            if response.status_code == 403:
                ...
                logger.warning("⚠️ POST /api/belge/upload with no auth returns 200 - authentication may not be enforced")
        except Exception as e:
    ...
    def test_04_belge_download(self):
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                logger.warning("⚠️ GET /api/belge/download/{id} with invalid auth returns 200 - authentication may not be enforced")
        except Exception as e:
