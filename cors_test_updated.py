...
class TestCORSConfiguration(unittest.TestCase):
    ...
    def test_cors_preflight_stats(self):
        ...
        try:
            ...
            # Check if GET method is allowed (either explicitly or via wildcard)
            methods_header = response.headers.get("Access-Control-Allow-Methods")
            self.assertTrue(methods_header == "*" or "GET" in methods_header.split(",") if "," in methods_header else [methods_header], 
