        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-90vh overflow-y-auto">
            ...
            <form onSubmit={handleConsumptionSubmit} className="p-6 space-y-4">
              ...
              <div className="border-t pt-4 mt-4">
                <h4 className="font-medium text-gray-700 mb-3">🧊 DEFRA Soğutucu Gazlar (F-Gases)</h4>
                <p className="text-xs text-gray-500 mb-3">Klimalar, soğutucular, minibarlar için kullanılan gazlar (kg CO2 equivalent)</p>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      ❄️ HFC Gazları (kg CO2e)
                    </label>
                    <input
                      type="number"
                      step="0.01"
                      value={consumptionData.hfc_gases || ''}
                      onChange={(e) => setConsumptionData({...consumptionData, hfc_gases: e.target.value})}
                      className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      🧊 Diğer F-Gases (kg CO2e)
                    </label>
                    <input
                      type="number"
                      step="0.01"
                      value={consumptionData.other_fgases || ''}
                      onChange={(e) => setConsumptionData({...consumptionData, other_fgases: e.target.value})}
                      className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                      placeholder="0.00"
                    />
                  </div>
