...
def test_bulk_personnel_422_fix():
    ...
    try:
        ...
        response = requests.post(url_with_client_id, headers=headers_admin, json=bulk_personnel_payload, timeout=15)
    ...
    try:
        ...
        wrong_payload = {
            "personnel": [  # Wrong key name - should be "personnel_list"
                {
                    "full_name": "Test Personel",
                    "position": "Test Pozisyon"
                }
        ...
        if response.status_code == 422:
            try:
                ...
                logger.info("✅ BulkPersonnelRequest validation working correctly")
            except:
