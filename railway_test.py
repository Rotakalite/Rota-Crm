...
def main():
    ...
    test_endpoint(f"{RAILWAY_API_URL}/health")
    test_endpoint(f"{RAILWAY_API_URL}/clients", headers)
    test_endpoint(f"{RAILWAY_API_URL}/documents", headers)
    test_endpoint(f"{RAILWAY_API_URL}/trainings", headers)
    
    # Test email management endpoints
    test_endpoint(f"{RAILWAY_API_URL}/email-management/clients-real", headers)
    test_endpoint(f"{RAILWAY_API_URL}/email-management/documents-real", headers)
    test_endpoint(f"{RAILWAY_API_URL}/email-management/trainings-real", headers)
